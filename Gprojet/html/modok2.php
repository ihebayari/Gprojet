...
<head>
  ...
  <div class="container-fluid">
	...
	<p>
	<h2 style="margin-top: 5% ;text-align: justify;"> <font size="15px" color="#efed40" translate="-20px">Gestion  des projet</font> </h2>
        ...
        <table class="table2" border="3" >
        	<tr>   <td style="position: relative; width:200px ;height:30px">
                ...
                <tr>
                    ...
                    <td><center><font size="5px" color="#efed40">details</font></center></td>
                       <td colspan="2"><center><font size="5px" color="#efed40">Fct</font></center></td>
                </tr>
            <?php 
            while ($row = $reponse->fetch())
{
  ...
  function m(){
    document.forms['monform'].action = 'modifmed.php';
   
    document.forms['monform'].submit();
  }
    function a(){
    document.forms['monform'].action = 'ajoutmed.php';
